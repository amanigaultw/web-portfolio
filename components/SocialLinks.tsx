export default function SocialLinks() {
  const socials = [
    ...
    //   icon: (
    //     <svg className="h-6 w-6 hover:text-blue-600 transition-all duration-300" fill="currentColor" viewBox="0 0 35 35">
    ...
    // },
    {
      ...
      icon: (
        <svg className="h-6 w-6 hover:text-blue-600 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
